...
// // Based on http://trac.webkit.org/browser/trunk/LayoutTests/fast/forms/script-tests/input-number-keyoperation.js?rev=896#L9
// // By Peter Janes
...
Modernizr.addTest('localizedNumber', function() {
    ...
    el.innerHTML = '<input type="number" value="1." step=".1"/>';
    input = el.childNodes[];
    root.appendChild(el);
    input.focus();
    try {
